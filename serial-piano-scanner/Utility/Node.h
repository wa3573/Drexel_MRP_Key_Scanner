...
//struct NodeIterator: public boost::iterator<std::random_access_iterator_tag,
//		typename Traits::value_type, typename Traits::difference_type,
//		typename Traits::pointer, typename Traits::reference> {
//	typedef boost::iterator<std::random_access_iterator_tag,
//			typename Traits::value_type, typename Traits::difference_type,
//			typename Traits::pointer, typename Traits::reference> base_iterator;
//
...
//	typedef typename boost::cb_details::iterator<
//			boost::circular_buffer<OutputType>, NonConstTraits> cb_iterator;
//
...
//			const NodeIterator<OutputType, Traits0, Traits1>& it) const
//	{
...
//	{
//		return NodeIterator<OutputType, Traits, NonConstTraits>(*this) += n;
//	}
//	NodeIterator operator -(difference_type n) const
//	{
//		return NodeIterator<OutputType, Traits, NonConstTraits>(*this) -= n;
...
//	bool operator ==(
//			const NodeIterator<OutputType0, Traits0, Traits1>& it) const
//	{
...
//	{
//	}
//	explicit NodeReverseIterator(T baseIt) :
//		std::reverse_iterator<T>(baseIt)
//	{
//	}
//
...
//	size_type index() const
//	{
//		return std::prev(this->base_reference()).index();
//	}
//	timestamp_type timestamp() const
//	{
//		return std::prev(this->base_reference()).timestamp();
//	}
//};
//
///*
...
//struct NodeInterpolatedIterator: public boost::iterator<
...
//	NodeInterpolatedIterator() :
//			m_buff(0), m_index(0.0), m_step(1.0)
//	{
//	}
//
//	// Constructor that should be used primarily by the Node class itself
//	NodeInterpolatedIterator(Node<OutputType>* buff, double index,
//			double stepSize) :
...
//
//	// Copy constructor
//	NodeInterpolatedIterator(const self_type& obj) :
//			m_buff(obj.m_buff), m_index(obj.m_index), m_step(obj.m_step)
//	{
//	}
//
//	// ***** Operators *****
...
//	{
//		return m_buff->interpolate(m_index);
//	}
//	pointer operator ->() const
//	{
//		return &(operator*());
...
//	double operator -(const self_type& it) const
//	{
...
//	}
//
//	self_type operator +(double n) const
//	{
//		return NodeInterpolatedIterator<OutputType, Traits>(*this) += n;
//	}
//	self_type operator -(double n) const
//	{
//		return NodeInterpolatedIterator<OutputType, Traits>(*this) -= n;
//	}
//
//	reference operator [](double n) const
//	{
//		return *(*this + n);
//	}
//
...
//	bool operator ==(
//			const NodeInterpolatedIterator<OutputType0, Traits0>& it) const
//	{
//		return m_index == it.m_index;
//	}
//
...
//			const NodeIterator<OutputType0, Traits0, Traits1>& it) const
//	{
//		return m_index == (double) it.index();
//	}
//
//	template<class OutputType0, class Traits0, class Traits1>
//	bool operator !=(
...
//			m_index = ((target - before) / (after - before))
//					+ (double) (afterIndex - 1);
//		} else if (ts < 0) {
...
//	timestamp_type timestamp() const
//	{
//		return m_buff->interpolatedTimestampAt(m_index);
//	}
//
//	// Tells us whether the index points to a valid place in the buffer.
//	bool isValid() const
//	{
//		return (m_index >= m_buff->beginIndex()
//				&& m_index <= (m_buff->endIndex() - 1));
//	}
//};
//
///*
...
//	bool try_lock_mutex()
//	{
//		return bufferAccessMutex_.tryEnter();
//	}
//	void unlock_mutex()
//	{
...
//			std::allocator<OutputType> > Alloc;
//
...
//	explicit NodeNonInterpolating(capacity_type capacity) :
...
//
//	// Copy constructor
//	NodeNonInterpolating(const NodeNonInterpolating<OutputType>& obj) :
//			numSamples_(obj.numSamples_), firstSampleIndex_(
//					obj.firstSampleIndex_)
//	{
//		if (obj.buffer_ != 0)
//			this->buffer_ = new boost::circular_buffer<OutputType>(
//					*obj.buffer_);
//		else
//			this->buffer_ = 0;
//		if (obj.timestamps_ != 0)
//			timestamps_ = new boost::circular_buffer<timestamp_type>(
//					*obj.timestamps_);
//		else
//			this->timestamps_ = 0;
//	}
...
//	{
//		return const_iterator(this, buffer_->begin());
//	}
//	const_iterator end()
//	{
//		return const_iterator(this, buffer_->end());
//	}
...
//	}
//
//	const_iterator iteratorAtIndex(size_type index)
//	{
//		return const_iterator(this, buffer_->begin())
//				+ (index - firstSampleIndex_);
//	}
//	const_reverse_iterator riteratorAtIndex(size_type index)
//	{
//		return const_reverse_iterator(iteratorAtIndex(index + 1));
//	}
//
...
//	{
//		return this->buffer_->at(index - this->firstSampleIndex_);
//	}
...
//	}			// Reserve: how many elements are left before the buffer is full
//	size_type capacity() const
//	{
//		return buffer_->capacity();
//	}		// Capacity: how many elements could be in the buffer
//
...
//	// is missing.
//
//	reference rawValueAt(size_type index)
//	{
//		return (*buffer_)[index - firstSampleIndex_];
//	}
//
//public:
//	// ***** Timestamp Methods *****
...
//	{
//		return timestamps_->at(index - this->firstSampleIndex_);
//	}
...
//	{
//		boost::circular_buffer<timestamp_type>::iterator it = std::find_if(
//				timestamps_->begin(), timestamps_->end(),
//				t < boost::lambda::_1);
//		if (it == timestamps_->end())
//			return timestamps_->size() - 1 + this->firstSampleIndex_;
//		if (it - timestamps_->begin() == 0)
//			return this->firstSampleIndex_;
//		return (size_type) ((--it) - timestamps_->begin())
//				+ this->firstSampleIndex_;
//	}
...
//				timestamps_->begin(), timestamps_->end(),
//				t < boost::lambda::_1);
//		return std::min<size_type>((it - timestamps_->begin()),
//				timestamps_->size() - 1) + this->firstSampleIndex_;
//	}
...
//	}
//
//	const_iterator nearestTo(timestamp_type t)
//	{
//		return begin() + (difference_type) indexNearestTo(t);
//	}
//	const_iterator nearestBefore(timestamp_type t)
//	{
//		return begin() + (difference_type) indexNearestBefore(t);
//	}
//	const_iterator nearestAfter(timestamp_type t)
//	{
//		return begin() + (difference_type) indexNearestAfter(t);
//	}
//
//	const_reverse_iterator rnearestTo(timestamp_type t)
//	{
//		return rend() - (difference_type) indexNearestTo(t);
//	}
//	const_reverse_iterator rnearestBefore(timestamp_type t)
//	{
//		return rend() - (difference_type) indexNearestBefore(t);
//	}
//	const_reverse_iterator rnearestAfter(timestamp_type t)
//	{
//		return rend() - (difference_type) indexNearestAfter(t);
//	}
//
//private:
...
//	typedef NodeInterpolatedIterator<OutputType,
//			boost::cb_details::const_traits<Alloc> > interpolated_iterator;
//
...
//			NodeNonInterpolating<OutputType>(capacity)
//	{
//	}
//	Node(Node<OutputType> const& obj) :
//			NodeNonInterpolating<OutputType>(obj)
//	{
//	}
//
...
//			return val1;
//		OutputType val2 = this->buffer_->at(
//				before + 1 - this->firstSampleIndex_);
...
//	}
//
//	interpolated_iterator interpolatedBegin(double step = 1.0)
//	{
//		return interpolated_iterator(this, (double) this->beginIndex(), step);
//	}
//	interpolated_iterator interpolatedEnd(double step = 1.0)
//	{
//		return interpolated_iterator(this, (double) this->endIndex(), step);
//	}
//	interpolated_iterator interpolatedIteratorAtIndex(double index,
//			double step = 1.0)
//	{
//		return interpolated_iterator(this, index, step);
//	}
//
...
//		double frac = (timestamp - beforeTimestamp)
...
public:
	// Useful type shorthands.  See <boost/circular_buffer.hpp> for details.
    typedef typename boost::cb_details::allocator_traits<std::allocator<OutputType> > Alloc;
