...
struct NodeIterator: public std::iterator<std::random_access_iterator_tag,
...
struct NodeReverseIterator: public boost::reverse_iterator<T> {
	...
	explicit NodeReverseIterator(T baseIt) :
			boost::reverse_iterator<T>(baseIt)
	{
	}
...
struct NodeInterpolatedIterator: public std::iterator<
